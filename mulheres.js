...
const cors = require('cors') //traz o pacote cors que permite consumir essa API no fron-end

//ligando o banco de dados ao programa
const conectaBancoDeDados = require('./bancoDeDados')
conectaBancoDeDados() //chama a função para conectar o BD

const Mulher = require('./mulherModel')

const app = express() //iniciando o app
app.use(express.json()) //config request - config pedidos feitos pela aplicação
app.use(cors())
